    ...
    <div className="site">
      ...
      <div className="app">
        <div className="nameplate">
          <div className="namecard">
            ...
            <div className="links">
              ...
              <a
                href="https://en.wikipedia.org/wiki/Gmail"
                target="_blank"
                rel="noreferrer"
        ...
        <div className="skillcontainer">
          <h1 className="skilltitle" style={{ backgroundColor: "dodgerblue" }}>
            Stuff I Work With
          </h1>
          <div className="skillshowcase">
            <SkillShowcase
              ...
              tech={"React"}
              description={
                "React makes up the frontend of most of my projects. I love the component based architecture and the speed it provides."
              }
            />
            <SkillShowcase
              ...
              tech={"Python"}
              description={
                "Python is my go to for backend development. I love the simplicity and readability of the language."
              }
            />
            <SkillShowcase
              ...
              tech={"MySQL"}
              description={
                "I primarily use MySQL for database management. I have experience with relational databases and perfer them to non-relational models."
              }
            />
          </div>
          <h2 className="skilltitle" style={{ backgroundColor: "#6495ED" }}>
